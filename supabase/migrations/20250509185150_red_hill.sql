/*
  # Add Credit Management Functions for Stripe Integration

  1. New Functions
    - `add_credits` - Adds one-time purchase credits to a user account
    - `add_subscription_credits` - Manages subscription-based credits
    
  2. Purpose
    - Support Stripe integration for credit purchases
    - Provide clean interface for adding credits to user accounts
    - Support both one-time purchases and subscription models
*/
