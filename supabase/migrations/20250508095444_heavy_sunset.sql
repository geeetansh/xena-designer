/*
  # Fix Stuck Photoshoots

  1. New Functions:
    - `rescue_stuck_photoshoots` - Function to fix photoshoots that are stuck in processing state
    - `detect_status_mismatches` - Function to identify mismatches between photoshoots and tasks

  2. Purpose:
    - Repair photoshoots that should be completed or failed but are stuck in processing
    - Provide diagnostic tools for finding inconsistencies in the database
    - Run a one-time fix for any current stuck photoshoots
*/
